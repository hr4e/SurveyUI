"""
Django settings for HR4E_UI project.
...
SECRET_KEY = 'ew*=^2imxctdj7uqvj_+25)^-qzjrkh8tv68n)yx&_!i==b$zf'
...
ROOT_URLCONF = 'HR4E_UI.urls'

WSGI_APPLICATION = 'HR4E_UI.wsgi.application'
